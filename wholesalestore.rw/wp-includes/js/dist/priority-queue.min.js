/*! This file is auto-generated */ ! function() {
    var e = {
            3159: function(e, t, n) {
                ...
                r = [], void 0 === (i = "function" == typeof(o = function() {
                    "use strict";
                    var e, t, o, r, i = "undefined" != typeof window ? window : null != typeof n.g ? n.g : this || {},
                    ...
                    function D() {
                        var n, r, i, u = d > 9 ? 9 : 1;
                        if (p = Date.now(), s = !1, o = null, l > 2 || p - t - 50 < e)
                            for (r = 0, i = c.length; r < i && w.timeRemaining() > u; r++) n = c.shift(), v++, n && n(w);
                        c.length ? C() : l = 0
                    }
                    ...
                    if (i.requestIdleCallback && i.cancelIdleCallback) try {
                        ...
                        ! function(e) {
                            var t, n;
                            if (i.requestIdleCallback = function(t, n) {
                    ...
                    } else i.requestIdleCallback = I, i.cancelIdleCallback = O, i.document && document.addEventListener && (i.addEventListener("scroll", k, !0), i.addEventListener("resize", k), document.addEventListener("focus", k, !0), document.addEventListener("mouseover", k, !0), ["click", "keypress", "touchstart", "mousedown"].forEach((function(e) {
                        document.addEventListener(e, k, {
                            capture: !0,
                            passive: !0
                        })
                    })), i.MutationObserver && new MutationObserver(k).observe(document.documentElement, {
                        childList: !0,
                        subtree: !0,
                        attributes: !0
                    }));
    ...
    ! function() {
        ...
        n(3159);
        var e = "undefined" == typeof window ? e => {
        ...
        const t = () => {
            ...
            const o = r => {
                for (const [e, n] of t)
                    if (t.delete(e), n(), "number" == typeof r || r.timeRemaining() <= 0) break;
                0 !== t.size ? e(o) : n = !1
            };
            return {
                add: (r, i) => {
