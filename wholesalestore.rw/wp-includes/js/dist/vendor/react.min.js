...
! function() {
    ...
    e = this, t = function(e) {
        function t(e, t, n) {
            this.props = e, this.context = t, this.refs = L, this.updater = n || T
        }
        ...
        function o(e, t, n) {
            var r, o = {},
                ...
                a = null;
            if (null != t)
                for (r in void 0 !== t.ref && (a = t.ref), void 0 !== t.key && (u = "" + t.key), t) D.call(t, r) && !V.hasOwnProperty(r) && (o[r] = t[r]);
        ...
        function i(e, t, n, r, o) {
            ...
            if (c) return o = o(c = e), e = "" === r ? "." + a(c, 0) : r, M(o) ? (n = "", null != e && (n = e.replace(q, "$&/") + "/"), i(o, t, n, "", (function(e) {
                return e
            ...
            }(o, n + (!o.key || c && c.key === o.key ? "" : ("" + o.key).replace(q, "$&/") + "/") + e)), t.push(o)), 1;
            if (c = 0, r = "" === r ? "." : r + ":", M(e))
        ...
        function v(e, t) {
            ...
            var n = Q;
            try {
                for (d(t), K = s(Y); null !== K && (!(K.expirationTime > t) || e && !m());) {
                    var r = K.callback;
                    if ("function" == typeof r) {
                        K.callback = null, Q = K.priorityLevel;
                        var o = r(K.expirationTime <= t);
                        t = z(), "function" == typeof o ? K.callback = o : K === s(Y) && p(Y), d(t)
                    } else p(Y);
                    K = s(Y)
                }
                if (null !== K) var u = !0;
        ...
        if ("object" == typeof performance && "function" == typeof performance.now) var B = performance,
            z = function() {
                return B.now()
            };
        else {
        ...
        if ("function" == typeof re) var fe = function() {
            re(ce)
        };
        else if ("undefined" != typeof MessageChannel) {
            var se = (F = new MessageChannel).port2;
            F.port1.onmessage = ce, fe = function() {
                se.postMessage(null)
            }
        } else fe = function() {
            te(ce, 0)
        ...
        F = {
            ...
            Scheduler: {
                ...
                unstable_scheduleCallback: function(e, t, n) {
                    ...
                    return e = {
                        ...
                        sortIndex: -1
                    }, n > r ? (e.sortIndex = n, f(G, e), null === s(Y) && e === s(G) && (ee ? (ne(ae), ae = -1) : ee = !0, h(b, n - r))) : (e.sortIndex = o, f(Y, e), Z || X || (Z = !0, _(v))), e
                },
        ...
        }, e.Component = t, e.Fragment = w, e.Profiler = x, e.PureComponent = r, e.StrictMode = S, e.Suspense = P, e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = F, e.cloneElement = function(e, t, n) {
            ...
            var r = O({}, e.props),
                ...
                a = e._owner;
            if (null != t) {
                if (void 0 !== t.ref && (u = t.ref, a = U.current), void 0 !== t.key && (o = "" + t.key), e.type && e.type.defaultProps) var i = e.type.defaultProps;
                for (l in t) D.call(t, l) && !V.hasOwnProperty(l) && (r[l] = void 0 === t[l] && void 0 !== i ? i[l] : t[l])
            }
