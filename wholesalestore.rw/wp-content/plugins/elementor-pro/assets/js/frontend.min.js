        ...
        2090: (e, t) => {
            ...
            var n = elementorModules.frontend.handlers.Base.extend({
                ...
                getConfig() {
                    ...
                    return n.length && "top" === e.sticky && "fixed" === n.css("position") && (t.offset += n.height()), t.relativeTarget = s ? "document" : "parent", e.sticky_parent && (i || o) && (t.parent = ".e-container, .e-container__inner, .e-con, .e-con-inner, .elementor-widget-wrap"), t
                },
                activate() {
