! function(m, f, v, b) {
    ...
    function t() {
        ...
        var l, g, d = !c && (b.settings.message_badge || !s || !i || !a);
        ...
        setTimeout(function() {
            b.show(d)
        }, n), s && i && !c && (b.settings.message_badge ? e = setTimeout(function() {
            b.$(".joinchat__badge").addClass("joinchat__badge--in")
        }, n + i) : a && (e = setTimeout(r, n + i))), o && !b.is_mobile && b.$(".joinchat__button").on("mouseenter", function() {
            t = setTimeout(r, 1500)
        ...
        }), b.is_mobile && (m(v).on("focus blur", "input, textarea", function(t) {
            m(t.target).closest(b.$div).length || (clearTimeout(l), l = setTimeout(u, 200))
        }), m(f).on("resize", function() {
            clearTimeout(g), g = setTimeout(function() {
                b.$div[0].style.setProperty("--vh", f.innerHeight + "px")
            }, 200)
        }).trigger("resize"));
        var p, h = new URL(f.location);
        "#joinchat" == h.hash && (b.show(), setTimeout(r, 700)), h.searchParams.has("joinchat") && (s = 1e3 * (parseInt(h.searchParams.get("joinchat")) || 0), setTimeout(function() {
            b.show()
        }, s), setTimeout(r, 700 + s)), m(v).on("click", '.joinchat_open, .joinchat_app, a[href="#joinchat"], a[href="#whatsapp"]', function(t) {
        ...
        }), o && "IntersectionObserver" in f && 0 < (a = m(".joinchat_show, .joinchat_force_show")).length && (p = new IntersectionObserver(function(t) {
            m.each(t, function() {
                if (0 < this.intersectionRatio && (!c || m(this.target).hasClass("joinchat_force_show"))) return r(), p.disconnect(), !1
            })
        }), a.each(function() {
            p.observe(this)
        })), b.use_qr() ? b.$(".joinchat__qr").append(b.qr(b.whatsapp_link(void 0, void 0, !1))) : b.$(".joinchat__qr").remove(), o && b.$div.css("--peak", "url(#joinchat__peak_" + (b.$div.closest("[dir=rtl]").length ? "r" : "l") + ")"), m(v).trigger("joinchat:start"), b.is_ready = !0
    }
    b = m.extend({
        $div: null,
        settings: null,
        ...
        }, t)).event_label = t.event_label || t.link || "", t.event_action = t.event_action || t.chat_channel + ": " + t.chat_id, delete t.link, !1 !== m(v).triggerHandler("joinchat:event", [t]) && (e = f[this.settings.data_layer] || f[f.gtm4wp_datalayer_name] || f.dataLayer, "function" == typeof gtag && "object" == typeof e && (n = this.settings.ga_event || "generate_lead", i = m.extend({
            transport_type: "beacon"
        }, t), m.each(i, function(t, e) {
        ...
        }), s = t.event_category, delete t.event_category, "object" == typeof e && e.push(m.extend({
            event: s
        }, t)), "function" == typeof fbq) && fbq("trackCustom", s, t)
        ...
        this.chatbox || (this.chatbox = !0, this.showed_at = Date.now(), this.$div.addClass("joinchat--chatbox"), this.settings.message_badge && this.$(".joinchat__badge").hasClass("joinchat__badge--in") && this.$(".joinchat__badge").toggleClass("joinchat__badge--in joinchat__badge--out"), m(v).trigger("joinchat:show"))
        ...
        !1 !== m(v).triggerHandler("joinchat:open", [t]) && (e.test(t.link) ? (this.send_event(t), f.open(t.link, "joinchat", "noopener")) : console.error("Joinchat: the link doesn't seem safe, it must point to the current domain or whatsapp.com"))
    }, b.optin = function() {
        ...
        return QrCreator.render(m.extend({
            text: t,
            radius: .4,
            background: "#FFF",
            size: 200
    ...
    n = function() {
        if (b.$div = m(".joinchat"), b.$div.length) {
            ...
            var n;
            b.settings && b.settings.telephone && (b.is_mobile || !b.settings.mobile_only ? t() : (b.hide(), m(v).on("click", '.joinchat_open, .joinchat_app, a[href="#joinchat"], a[href="#whatsapp"]', function(t) {
                t.preventDefault(), b.open_whatsapp(m(this).data("phone"), m(this).data("message"))
            })), b.can_qr && !b.is_mobile ? m(".joinchat-button__qr").each(function() {
                m(this).append(b.qr(b.whatsapp_link(m(this).data("phone"), m(this).data("message"), !1)))
            }) : m(".wp-block-joinchat-button figure").remove(), void 0 !== b.settings.sku) && (n = b.settings.message_send, m("form.variations_form").on("found_variation reset_data", function(t, e) {
