(() => {
    ...
    (() => {
        ...
        var E = {};
        r.r(E), r.d(E, {
            registerContainer: () => Ti,
            unregisterContainer: () => Ai
        });
        var g = {};
        r.r(g), r.d(g, {
            getRegisteredContainers: () => Pi
        });
        var S = {};
        r.r(S), r.d(S, {
        ...
        const xe = {},
            ...
            Be = e => !(e => null === e)(e) && e instanceof Object && e.constructor === Object;
        ...
        const $e = e => Be(e) && Fe(e, "code") && Fe(e, "message"),
            ...
            Ke = (e, t, r) => {
                ...
                (0, T.select)("wc/store/payment").isExpressPaymentMethodActive() || void 0 === a || (0, T.dispatch)("core/notices").createNotice(e, t, {
                    isDismissible: !0,
                    ...r,
                    context: a
                })
            ...
            Qe = e => ({
                ...
                ((e = null, t = null) => {
                    ...
                    (0, T.select)(b).hasFinishedResolution("getCartData") && (((e, t, r) => {
                        e.items.forEach((e => {
                            r.includes(e.key) || t.items.find((t => t && t.key === e.key)) || (0, T.dispatch)("core/notices").createInfoNotice((0, P.sprintf)( /* translators: %s is the name of the item. */ /* translators: %s is the name of the item. */
                        ...
                        t.items.forEach((t => {
                            ...
                            (s || i || n) && (n ? (0, T.dispatch)("core/notices").createInfoNotice((0, P.sprintf)( /* translators: %1$s is the name of the item, %2$d is the quantity of the item. %3$d is a number that the quantity must be a multiple of. */ /* translators: %1$s is the name of the item, %2$d is the quantity of the item. %3$d is a number that the quantity must be a multiple of. */
                            ...
                            }) : i ? (0, T.dispatch)("core/notices").createInfoNotice((0, P.sprintf)( /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */ /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */
                                ...
                                type: "snackbar",
                                id: `${t.key}-quantity-update`
                            }) : (0, T.dispatch)("core/notices").createInfoNotice((0, P.sprintf)( /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */ /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */
                        ...
                        t.items.forEach((t => {
                            ...
                            return a && t.key === a.key ? (t.quantity !== a.quantity && Ge(t) && (0, T.dispatch)("core/notices").createInfoNotice((0, P.sprintf)( /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */ /* translators: %1$s is the name of the item, %2$d is the quantity of the item. */
        ...
        var bt = r.n(Pt);
        const Rt = (e, t) => e[t] ? Array.from(e[t].values()).sort(((e, t) => e.priority - t.priority)) : [];
        let wt = function(e) {
        ...
        const It = (e, t) => Be(e) && "type" in e && e.type === t,
            ...
            Nt = e => {
                ...
                }, ...Array.isArray(s) ? s.flatMap((e => Fe(e, "code") && Fe(e, "message") ? [{
                    param: t,
                    id: `${t}_${e.code}`,
                    code: e.code,
            ...
            Ht = (e, t) => "string" != typeof t ? t : "email" === e ? (0, Ut.isEmail)(t) ? t.trim() : "" : "postcode" === e ? t.replace(" ", "").toUpperCase() : t.trim(),
            ...
            Bt = () => {
                ...
                const e = {};
                qt.dirtyProps.billingAddress.length && (e.billing_address = Tt(qt.customerData.billingAddress, qt.dirtyProps.billingAddress)), qt.dirtyProps.shippingAddress.length && (e.shipping_address = Tt(qt.customerData.shippingAddress, qt.dirtyProps.shippingAddress)), (0, T.dispatch)(b).updateCustomerData(e).then((() => {
                    qt.dirtyProps.billingAddress = [], qt.dirtyProps.shippingAddress = [], qt.doingPush = !1, (() => {
                        const e = (0, T.select)("wc/store/store-notices").getRegisteredContainers(),
                            {
                                removeNotice: t
                            } = (0, T.dispatch)("core/notices"),
                            {
                                getNotices: r
                            } = (0, T.select)("core/notices");
                        e.forEach((e => {
                            r(e).forEach((r => {
                                t(r.id, e)
                            }))
        ...
        const zt = async () => !!(0, T.select)(b).hasFinishedResolution("getCartData") && (await (0, T.dispatch)($t).__internalUpdateAvailablePaymentMethods(), !0),
            Kt = At(zt, 1e3),
        ...
        Xt.subscribe(((e = !0) => {
            if ((0, T.select)(b).hasFinishedResolution("getCartData")) return qt.customerDataIsInitialized ? void(bt()(qt.customerData, (0, T.select)(b).getCustomerData()) || (e ? Ft() : Bt())) : (qt.customerData = (0, T.select)(b).getCustomerData(), void(qt.customerDataIsInitialized = !0))
        })), document.body.addEventListener("focusout", (e => {
            e.target && e.target instanceof Element && "input" === e.target.tagName.toLowerCase() && Ft.flush()
        }));
        ...
        const ur = (0, w.getSetting)("wcBlocksConfig", {
            ...
            Sr = ((0, w.getSetting)("addressFieldsLocations", Er).contact, (0, w.getSetting)("addressFieldsLocations", Er).additional, (0, w.getSetting)("collectableMethodIds", [])),
            ...
            Yr = e => {
                if (void 0 === e.prefersCollection) {
                    ...
                    if (Fe(r, "method_id") && fr(r.method_id)) return t = null == r ? void 0 : r.method_id, !!_r && (Array.isArray(t) ? !!t.find((e => Sr.includes(e))) : Sr.includes(t))
                }
                var t;
            ...
            ra = e => ({
                ...
                t.__internalSetRedirectUrl((null == r ? void 0 : r.redirectUrl) || ""), (0, T.dispatch)($t).__internalSetPaymentResult(r), t.__internalSetAfterProcessing()
            },
            aa = ({
                observers: e,
            ...
            sa = ({
                ...
                r.hasError() ? ea(e, "checkout_fail", n).then((e => {
                    (({
                        observerResponses: e,
                        notices: t,
                        dispatch: r,
                        ...
                        const i = (({
                            ...
                            return e.forEach((e => {
                                if ((Ot(e) || Mt(e)) && e.message && fr(e.message)) {
                                    const a = e.messageContext && fr(e.messageContext) ? {
                        ...
                        if (null !== i) kt(i) ? r.__internalSetIdle() : r.__internalSetComplete(i);
                        else {
                            var n;
                    ...
                    (({
                        ...
                        if (e.forEach((e => {
                            ...
                            if (s.message && fr(s.message)) {
                                const e = s.messageContext && fr(s.messageContext) ? {
                                    context: s.messageContext
                                } : void 0;
                                r(s.message, e)
                            }
                            kt(s) ? t.__internalSetHasError(!0) : t.__internalSetComplete(s)
            ...
            fa = e => {
                ...
                return void 0 !== e.label && (t.label = e.label), void 0 !== e.required && (t.required = e.required), void 0 !== e.hidden && (t.hidden = e.hidden), void 0 === e.label || e.optionalLabel || (t.optionalLabel = (0, P.sprintf)( /* translators: %s Field label. */ /* translators: %s Field label. */
                    (0, P.__)("%s (optional)", "woocommerce"), e.label)), e.priority && ("number" == typeof e.priority && (t.index = e.priority), fr(e.priority) && (t.index = parseInt(e.priority, 10))), e.hidden && (t.required = !1), t
            },
            va = Object.entries(yr).map((([e, t]) => [e, Object.entries(t).map((([e, t]) => [e, fa(t)])).reduce(((e, [t, r]) => (e[t] = r, e)), {})])).reduce(((e, [t, r]) => (e[t] = r, e)), {}),
            Ta = e => {
                const t = ((e, t, r = "") => {
            ...
            Aa = {
                ...
                calculatingCount: 0,
                orderNotes: "",
                useShippingAsBilling: (Pa = er.billing_address, ba = er.shipping_address, gr.every((e => Pa[e] === ba[e]))),
        ...
        const Ra = {
                reducer: (e = Aa, t) => {
                    ...
                    switch (t.type) {
                        ...
                        case Br:
                            a = { ...e,
                                status: Jt.PROCESSING,
                                hasError: !1
                            };
                            break;
                        case Vr:
                            a = { ...e,
                                status: Jt.BEFORE_PROCESSING,
                                hasError: !1
                            };
                            break;
                        case qr:
                            a = { ...e,
                                status: Jt.AFTER_PROCESSING
                            };
                            break;
                        case Fr:
                            a = { ...e,
                                hasError: t.hasError,
                                status: e.status === Jt.PROCESSING || e.status === Jt.BEFORE_PROCESSING ? Jt.IDLE : e.status
                            };
                            break;
                        case zr:
                            a = { ...e,
        ...
        const Ca = Zt,
            ...
            Da = [],
            Oa = (e, t) => !!t && !!t.reduce(((e, t) => "object" == typeof e && null !== e ? e[t] : void 0), e);
        ...
        const ka = ({
                ...
                type: i = "items",
                fallback: n = Da
            }) => Ma(e, [t, r, s = JSON.stringify(s), a = null !== a ? (0, Ut.addQueryArgs)("", a) : "", i]) ? e[t][r][s][a][i] : n,
            Na = (e, t, r, a = null, s = Da) => ka({
                state: e,
                namespace: t,
                resourceName: r,
                query: a,
        ...
        function* Fa(e, t, r, a) {
            const s = yield T.controls.resolveSelect(Ba, "getRoute", e, t, a), i = (0, Ut.addQueryArgs)("", r);
            if (s) try {
                const {
                    response: r = Da,
                    headers: n
                ...
                n && n.get && n.has("last-modified") && (yield function*(e) {
                    const t = yield T.controls.resolveSelect(Ia, "getCollectionLastModified");
                    t ? e > t && (yield T.controls.dispatch(Ia, "invalidateResolutionForStore"), yield T.controls.dispatch(Ia, "receiveLastModified", e)) : yield T.controls.dispatch(Ia, "receiveLastModified", e)
                }(parseInt(n.get("last-modified"), 10))), yield Ha(e, t, i, a, {
                    items: r,
                    headers: n
                })
            } catch (r) {
        ...
        const Ka = (0, T.createReduxStore)(Ia, {
            reducer: (e = {}, t) => {
                if (t.type === Ua.RECEIVE_LAST_MODIFIED) return t.timestamp === e.lastModified ? e : { ...e,
        ...
        const Za = e => Object.fromEntries(e.map((({
                package_id: e,
                shipping_rates: t
            }) => {
                var r;
            ...
            rs = {
                coupons: [],
                shipping_rates: (0, w.getSetting)("shippingMethodsExist", !1) || (0, w.getSetting)("localPickupEnabled", !1) ? es : [],
                items: [{
                    key: "1",
                    id: 1,
                    type: "simple",
            ...
            as = (e, t, r = !1) => {
                const {
                    createErrorNotice: a
                } = (0, T.dispatch)("core/notices"), s = r ? Ct.EXPRESS_PAYMENTS : Ct.PAYMENTS;
...
(0,P.__)("There was an error registering the payment method with id '%s': ","woocommerce"),e.paymentMethodId)} ${t}`, {
            ...
            ss = async (e = !1) => {
                ...
                const c = Object.keys(t),
                    l = e ? (0, T.select)($t).getAvailableExpressPaymentMethods() : (0, T.select)($t).getAvailablePaymentMethods();
            ...
            is = async e => {
                const t = Object.keys(e),
                    r = Object.keys((0, T.select)($t).getAvailableExpressPaymentMethods()),
                    a = [...t, ...r],
                ...
                n && a.includes(n) || ((0, T.dispatch)($t).__internalSetPaymentIdle(), (0, T.dispatch)($t).__internalSetActivePaymentMethod(t[0]))
            },
            ns = window.wp.deprecated;
        var os = r.n(ns);
        const cs = e => ["first_name", "last_name", "company", "address_1", "address_2", "city", "state", "postcode", "country", "phone"].every((t => Fe(e, t))),
            ...
            us = (e, t) => ({
                ...
                return i("wc-payment-error", Ct.PAYMENTS), ea(e, "payment_setup", {}).then((e => {
                    let i, n, o, c;
                    e.forEach((e => {
                        ...
                        o = t, c = a, r && (o = r, os()("returning billingData from an onPaymentProcessing observer in WooCommerce Blocks", {
                            version: "9.5.0",
                            alternative: "billingAddress",
                            link: "https://github.com/woocommerce/woocommerce-blocks/pull/6369"
                        })), Fe(s, "address") && s.address && (c = s.address, os()("returning shippingData from an onPaymentProcessing observer in WooCommerce Blocks", {
                            version: "9.5.0",
                    ...
                    if (Jr(i) && !n) {
                        ...
                        ls(o) && l(o), cs(c) && d(c), r.__internalSetPaymentMethodData(Be(e) ? e : {}), r.__internalSetPaymentReady()
                    } else if (Mt(n)) {
                        var p;
                        const {
                            paymentMethodData: e
                        ...
                        if (Fe(n, "message") && fr(n.message) && n.message.length) {
                            let e = Ct.PAYMENTS;
                            Fe(n, "messageContext") && fr(n.messageContext) && n.messageContext.length && (e = n.messageContext), s(n.message, {
                                id: "wc-payment-error",
                                isDismissible: !1,
                                context: e
                            })
                        }
                        ls(o) && l(o), r.__internalSetPaymentMethodData(Be(e) ? e : {}), r.__internalSetPaymentError()
                    } else if (Ot(n)) {
                        if (Fe(n, "message") && fr(n.message) && n.message.length) {
                            let e = Ct.PAYMENTS;
                            Fe(n, "messageContext") && fr(n.messageContext) && n.messageContext.length && (e = n.messageContext), s(n.message, {
                        ...
                        r.__internalSetPaymentError(), _ = n.validationErrors, Be(_) && Object.entries(_).every((([e, t]) => {
                            return fr(e) && Be(r = t) && Fe(r, "message") && Fe(r, "hidden") && fr(r.message) && "boolean" == typeof r.hidden;
                            var r
            ...
            ps = () => ({
                type: Wa.SET_PAYMENT_IDLE
            }),
            _s = () => ({
                type: Wa.SET_EXPRESS_PAYMENT_STARTED
            }),
            ms = () => ({
                type: Wa.SET_PAYMENT_PROCESSING
            }),
            hs = () => ({
                type: Wa.SET_PAYMENT_ERROR
            }),
            ys = () => ({
                type: Wa.SET_PAYMENT_READY
            }),
            Es = e => async ({
                select: t,
                dispatch: r
                ...
                e && await is(a), r({
                    type: Wa.SET_PAYMENT_METHODS_INITIALIZED,
                    initialized: e
                })
            },
            gs = e => ({
            ...
            As = e => async ({
                ...
                r.getActivePaymentMethod() in e || await is(e), t({
                    type: Wa.SET_AVAILABLE_PAYMENT_METHODS,
                    paymentMethods: e
                })
            },
            Ps = e => ({
            ...
            bs = e => ({
                type: Wa.REMOVE_AVAILABLE_PAYMENT_METHOD,
                name: e
            }),
            Rs = e => ({
        ...
        const Is = e => (os()("isPaymentPristine", {
                since: "9.6.0",
            ...
            Ys = e => (os()("isPaymentFailed", {
                since: "9.6.0",
                plugin: "WooCommerce Blocks",
                link: "https://github.com/woocommerce/woocommerce-blocks/pull/8110"
            }), e.status === Gt.ERROR),
            Us = e => Object.keys(e.availableExpressPaymentMethods).includes(e.activePaymentMethod),
            js = e => "object" == typeof e.paymentMethodData && Fe(e.paymentMethodData, "token") ? e.paymentMethodData.token + "" : "",
            ...
            Fs = e => {
                ...
                return a && s ? Object.fromEntries(Object.entries(Cs).filter((([e]) => !(e in { ...t,
                    ...r
                })))) : {}
            },
                ...
                reducer: (e = Qa, t) => {
                    ...
                    switch (t.type) {
                        ...
                        case Wa.SET_EXPRESS_PAYMENT_STARTED:
                            r = { ...e,
                                status: Gt.EXPRESS_STARTED
                            };
                            break;
                        case Wa.SET_PAYMENT_PROCESSING:
                            r = { ...e,
                                status: Gt.PROCESSING
                            };
                            break;
                        ...
                        case Wa.SET_ACTIVE_PAYMENT_METHOD:
                            const i = "object" == typeof e.paymentMethodData && Fe(t.paymentMethodData, "token") ? t.paymentMethodData.token + "" : "";
                            r = { ...e,
                                activeSavedToken: i,
        ...
        const gi = (0, T.combineReducers)({
                routes: (e = {}, t) => {
                    ...
                    return r === mi.RECEIVE_MODEL_ROUTES && a.forEach((t => {
        ...
        const Ti = e => ({
                type: vi.REGISTER_CONTAINER,
                containerContext: e
            }),
            Ai = e => ({
                type: vi.UNREGISTER_CONTAINER,
                containerContext: e
            }),
            Pi = e => e.containers,
            bi = {
        ...
        const Ii = Ri,
            ...
            Ui = () => (os()("clearAllValidationErrors", {
                version: "9.0.0",
            ...
            Gi = {
                reducer: (e = {}, t) => {
                    ...
                    switch (t.type) {
                        ...
                        case Oi:
                            return fr(t.error) && r.hasOwnProperty(t.error) ? (delete r[t.error], r) : r;
                        case Mi:
                            const {
                                errors: a
                            } = t;
                        ...
                        case ki:
                            return fr(t.error) && r.hasOwnProperty(t.error) ? (r[t.error].hidden = !0, r) : r;
                        case Ni:
                            return fr(t.error) && r.hasOwnProperty(t.error) ? (r[t.error].hidden = !1, r) : r;
                        case xi:
