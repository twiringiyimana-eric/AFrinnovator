(() => {
    ...
    const c = (e, t) => {
            e !== r && (a && t < a || (r = e, a = t || Date.now() / 1e3, window.localStorage.setItem("storeApiNonce", JSON.stringify({
                nonce: r,
                timestamp: a
            }))))
        },
    ...
    n().use(((e, t) => {
        ...
        })(e) && (e = i(e), Array.isArray(null === (o = e) || void 0 === o || null === (n = o.data) || void 0 === n ? void 0 : n.requests) && (e.data.requests = e.data.requests.map(i))), t(e, t)
    })), n().setNonce = e => {
        ...
        t && c(t, o)
    }, c(wcBlocksMiddlewareConfig.storeApiNonce, wcBlocksMiddlewareConfig.storeApiNonceTimestamp), (this.wc = this.wc || {}).wcBlocksMiddleware = t
})();